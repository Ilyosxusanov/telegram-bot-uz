...
async def set_commands(bot: Bot):
    commands = [
        ...
        types.BotCommand(command="movies", description="Barcha kinolar"),
        types.BotCommand(command="seryallar", description="Barcha seryallar"),
        types.BotCommand(command="anime", description="Barcha animelar"),
        types.BotCommand(command="multifilmlar", description="Barcha multfilmlar"),
